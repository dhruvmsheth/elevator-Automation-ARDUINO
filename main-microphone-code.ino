 ...
 *Created and Trained the Model by DhruvSheth
 */
...
void loop()
{
    ei_printf("Starting inferencing in 0 seconds...\n");
...
void RespondToCommand(tflite::ErrorReporter* error_reporter,
  ...
  if (!is_initialized) {
    ...
    digitalWrite(LEDR, HIGH); //Note that logic in Arduino BLE Sense 33 is different, turning LED to High is turning off the LED
    digitalWrite(LEDG, HIGH); // We have not defined servo here, we may respond servo command in the next snippet
